...
//Edge length will always be passed from the file to the constructor
	 ...
	 * @param edgeLength the edge length of each side of the shape Constructor with
	 *                   arguments for building a new octagonal prism
	 */
	...
	/**
	 * 
	 * @param edgeLength the edge length of each side of the shape Sets edge length
	 *                   for this object
	 */
	...
	/**
	 * 
	 * @return returns the volume of the prism calculated using the formula: Area *
	 *         height
	 */
	...
	/**
	 * 
	 * @return returns the area of the prism using the formula: 2 * (1 + square root
	 *         of 2) * s^2
	 */
